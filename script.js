let contaner2 = document.getElementsByClassName("container2")[0];
let contaner3 = document.getElementsByClassName("container3")[0];
...
function typeNote(){
    if(contaner3.style.display == "none"){
        contaner3.style.display = "block";
    } else {
        contaner3.style.display = "none";
    }
}
...
function createNote(){
    ...
    contaner2.insertAdjacentElement("beforeend", node0);
